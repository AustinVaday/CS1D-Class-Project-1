...
#include "../../DoJJ-Brochure_/userlogin.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_userLogin_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 28, 17)
    ...
    "userLogin\0on_login_clicked\0\0"
    "on_cancel_clicked"
};
...
const QMetaObject userLogin::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_userLogin.data,
      qt_meta_data_userLogin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_userLogin.stringdata))
