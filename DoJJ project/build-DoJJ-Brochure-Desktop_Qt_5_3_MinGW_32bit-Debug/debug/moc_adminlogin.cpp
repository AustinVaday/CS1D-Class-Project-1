...
#include "../../DoJJ-Brochure_/adminlogin.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_adminLogin_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 33, 22)
    ...
    "adminLogin\0on_authLogin_clicked\0\0"
    "on_cancelLogin_clicked"
};
...
void adminLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_authLogin_clicked(); break;
        case 1: _t->on_cancelLogin_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject adminLogin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_adminLogin.data,
      qt_meta_data_adminLogin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_adminLogin.stringdata))
