...
public:
    ...
    QListView *WineList_2;
    QLabel *PickWineryEdit;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        AddNewWinery = new QWidget();
        AddNewWinery->setObjectName(QStringLiteral("AddNewWinery"));
        Title = new QLabel(AddNewWinery);
        Title->setObjectName(QStringLiteral("Title"));
        Title->setGeometry(QRect(280, 30, 111, 51));
        QFont font3;
        font3.setPointSize(16);
        Title->setFont(font3);
        nameLabel = new QLabel(AddNewWinery);
        ...
        WineList = new QListView(AddWines);
        WineList->setObjectName(QStringLiteral("WineList"));
        WineList->setGeometry(QRect(10, 100, 221, 391));
        ...
        nameLabel_2->setGeometry(QRect(300, 110, 71, 21));
        yearLabel = new QLabel(AddWines);
        yearLabel->setObjectName(QStringLiteral("yearLabel"));
        yearLabel->setGeometry(QRect(300, 140, 71, 21));
        priceLabel = new QLabel(AddWines);
        priceLabel->setObjectName(QStringLiteral("priceLabel"));
        priceLabel->setGeometry(QRect(300, 170, 71, 21));
        wineName_2 = new QLineEdit(AddWines);
        wineName_2->setObjectName(QStringLiteral("wineName_2"));
        wineName_2->setGeometry(QRect(380, 110, 113, 20));
        wineYear = new QLineEdit(AddWines);
        wineYear->setObjectName(QStringLiteral("wineYear"));
        wineYear->setGeometry(QRect(380, 140, 113, 20));
        winePrice = new QLineEdit(AddWines);
        winePrice->setObjectName(QStringLiteral("winePrice"));
        winePrice->setGeometry(QRect(380, 170, 113, 20));
        AddWine = new QPushButton(AddWines);
        AddWine->setObjectName(QStringLiteral("AddWine"));
        AddWine->setGeometry(QRect(390, 220, 75, 23));
        ...
        WineList_2 = new QListView(EditWinery);
        WineList_2->setObjectName(QStringLiteral("WineList_2"));
        WineList_2->setGeometry(QRect(200, 90, 351, 351));
        PickWineryEdit = new QLabel(EditWinery);
        PickWineryEdit->setObjectName(QStringLiteral("PickWineryEdit"));
        PickWineryEdit->setGeometry(QRect(300, 60, 191, 21));
        PickWineryEdit->setFont(font1);
        pushButton_3 = new QPushButton(EditWinery);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(330, 450, 75, 23));
...
"password: password", 0));
        ...
        AddWineryButton->setText(QApplication::translate("MainWindow", "Add Winery", 0));
        ...
        PickWineryEdit->setText(QApplication::translate("MainWindow", "Pick Winery to Edit", 0));
